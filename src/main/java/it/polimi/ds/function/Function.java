...
/**
 * The Function class provides a set of static methods that perform basic mathematical operations such as addition, subtraction, multiplication, and division.
 */
